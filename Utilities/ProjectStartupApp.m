...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Beam Bending and Deflection';
            ...
            app.Image.ImageSource = 'image_3.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Beam Bending and Deflection';
